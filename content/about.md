...
I write both technical articles and development stories. You can use the [RSS](/atom.xml) {{icon(icon="rss")}} feed to get updates. You can also find me on the {{elink(content="Fediverse", url="https://elk.zone/fosstodon.org/@milomoisson", icon="fediverse")}}. Feel free to reach by mail {{icon(icon="email")}} at `milo[at]wiro[.]world` or on _Discord_ {{icon(icon="discord")}} at [@mrnossiom](https://discord.com/users/414017710091927552).
